...
class SyntaxeException2 : public InterpreteurException {
public:
    SyntaxeException2(const char * message = NULL) : m_message(message) {}
    const char * what() const throw() override {
        return m_message;
    }
private :
...
class PointVirguleEx : public InterpreteurException {
public:
    PointVirguleEx(const char * message = NULL) : m_message(message) {}
    const char * what() const throw() override {
        return m_message;
    }
private :
...
class FacteurEx : public InterpreteurException {
public:
    FacteurEx(const char * message = NULL) : m_message(message) {}
    const char * what() const throw() override {
        return m_message;
    }
private :
